...
public interface Verification {
  ...
  static VerificationResult verify(String sql0, String sql1, String schema) {
    return VerificationImpl.verify(sql0, sql1, schema, -1);
  }

  /**
   * Verify the equivalence of two SQL queries.
   * It resembles {@link Verification#verify(String, String, String)} except that it sets an intended upper bound
   * for the verification time.
   *
   * @param sql0 given the first sql.
   * @param sql1 given the second sql.
   ...
   */
  static VerificationResult verify(String sql0, String sql1, String schema, long timeout) {
    return VerificationImpl.verify(sql0, sql1, schema, timeout);
  }
  /**
