...
//    System.setOut(new PrintStream("log"));
    testLiaOnRulesConcrete(testCasesPath, targetId, eqCases, timeouts, "yale_test_2020");
  }

  @Test
  void testLiaOnYaleBenchmarks() throws IOException {
    Path testCasesPath = dataDir().resolve("yale").resolve("homework_2020");
    int targetId = -1;
    int[] eqCases = new int[]{};
    final Set<Integer> timeouts = Set.of();
    LogicSupport.setDumpLiaFormulas(true);
