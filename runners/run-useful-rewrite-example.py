...
def print_result(result):
    time_original_p50 = result[0]["p50"] / 1000000
    time_original_p99 = result[0]["p99"] / 1000000
    time_rewritten_p50 = result[1]["p50"] / 1000000
    time_rewritten_p99 = result[1]["p99"] / 1000000
    print("-- original: p50 = %.3f ms, p99 = %.3f ms"
          % (time_original_p50, time_original_p99))
    print("-- rewritten: p50 = %.3f ms, p99 = %.3f ms"
          % (time_rewritten_p50, time_rewritten_p99))
    print("* p50 improvement: %.2f%%" % ((time_original_p50 - time_rewritten_p50) * 100 / time_original_p50))
    print("* p99 improvement: %.2f%%" % ((time_original_p99 - time_rewritten_p99) * 100 / time_original_p99))
